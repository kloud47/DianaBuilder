    ...
    <TooltipProvider>
      ...
      >
        ...
        <aside className="flex items-center gap-2">
          ...
          <div className="bg-muted/60 rounded-full mx-2 mr-4">
            <Button
              disabled={!(state.history.currentIndex > 0)}
              onClick={handleUndo}
              variant={"ghost"}
              size={"icon"}
              className="hover:bg-slate-800 rounded-l-full border-r-2 border-background"
            >
              <Undo2 />
            </Button>
            <Button
              ...
              variant={"ghost"}
              size={"icon"}
              className="hover:bg-slate-800 rounded-r-full"
            >
              <Redo2 />
            </Button>
          </div>
